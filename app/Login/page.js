  ...
  return (
    <div className='flex flex-col justify-center items-center mt-[10%] gap-10'>
        ...
        <div className='px-6 sm:px-0 max-w-sm'>
            ...
            focus:ring-[#4285F4]/50 font-medium focus:outline-none 
            focus:ring-[#4285F4]/50 rounded-lg text-sm px-5 py-2.5
            ...
            dark:focus:ring-[#4285F4]/55 mr-2 mb-2 '>
                ...
                role="img" xmls="http://www.w3.org/2000/svg" viewBox='0 0 488 512'>
                    <path fill='currentColor' d='M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 
                    ...
                    0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z'></path>
                </svg>
                Sign up with Google
                <div></div>
            </button>
